<script lang="ts">
	import type { EventListener, MetaChildren } from '$components/interface';
	import { handleEvents } from '$modules/_attachments';
	import { profile } from '$store/basic.svelte';
	import { Icon } from '$components/element/index';
...
<svelte:element
	...
	data-aspect-ratio={props['ratio'] == 'square' ? props['ratio'] : undefined}
